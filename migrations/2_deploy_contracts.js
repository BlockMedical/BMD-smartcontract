...
var ipfsreward = artifacts.require("RewardDistributor");
...
module.exports = function(deployer, network, accounts) {
  ...
  deployer.deploy(erc20, 'BlockMed', 'BMD', {from: deploy_address}).then(function(erc20_i) {
    ...
    console.log("Funding TradeContract contract " + trade_i.address + " 1000000 tokens from accounts=" + deploy_address);
  }).then(function() {
    ...
    console.log("Funding RewardDistributor contract " + ipfsreward_instance.address + " with 1000000 tokens from accounts=" + deploy_address);
  });
};
